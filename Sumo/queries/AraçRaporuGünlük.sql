DROP PROCEDURE IF EXISTS AraçRaporuGünlük;

DELIMITER //
CREATE PROCEDURE AraçRaporuGünlük (IN p_araç_id VARCHAR(50),  IN p_tarih_baş DATE, IN p_tarih_bitiş DATE)
BEGIN
	SELECT  tarih AS Gün, 
...
CALL AraçRaporuGünlük('musoshi005', '2023-12-01', '2023-12-01')