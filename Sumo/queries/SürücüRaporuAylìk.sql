DROP PROCEDURE IF EXISTS SürücüRaporuAylık;

DELIMITER //
CREATE PROCEDURE SürücüRaporuAylık (IN p_sürücü_id INT, IN p_tarih_baş DATE, IN p_tarih_bitiş DATE)
BEGIN
    SELECT  t.Gün AS AY, 
...
CALL SürücüRaporuAylık(20, '2023-11-01' , '2024-01-11')