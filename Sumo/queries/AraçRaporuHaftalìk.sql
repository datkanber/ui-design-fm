DROP PROCEDURE IF EXISTS AraçRaporuHaftalık;

DELIMITER //
CREATE PROCEDURE AraçRaporuHaftalık (IN p_araç_id VARCHAR(50),  IN p_tarih_baş DATE, IN p_tarih_bitiş DATE)
BEGIN
    SELECT  
        t.Gün AS Hafta, 
...
CALL AraçRaporuHaftalık('musoshi005', '2023-12-01', '2024-01-5')