DROP PROCEDURE IF EXISTS RotaRaporuAylık;

DELIMITER //
CREATE PROCEDURE RotaRaporuAylık (IN p_tarih_baş DATE, IN p_tarih_bitiş DATE)
BEGIN
    SELECT  
        t.Gün AS Hafta, 
...
CALL RotaRaporuAylık('2023-12-30', '2024-12-30')