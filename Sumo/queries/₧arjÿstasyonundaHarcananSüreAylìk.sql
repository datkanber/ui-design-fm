DROP PROCEDURE IF EXISTS ŞarjİstasyonundaHarcananSüreAylık;

DELIMITER //
CREATE PROCEDURE ŞarjİstasyonundaHarcananSüreAylık(IN p_tarih_baş DATE, IN p_tarih_bitiş DATE)
BEGIN
    SELECT  
        t.Gün AS Ay, 
...
CALL ŞarjİstasyonundaHarcananSüreAylık('2023-12-01', '2024-01-31')