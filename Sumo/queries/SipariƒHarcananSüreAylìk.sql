DROP PROCEDURE IF EXISTS  SiparişHarcananSüreAylık;

DELIMITER //
CREATE PROCEDURE  SiparişHarcananSüreAylık(IN p_tarih_baş DATE, IN p_tarih_bitiş DATE)
BEGIN
    SELECT  
        t.Gün AS Ay, 
...
CALL SiparişHarcananSüreAylık('2023-12-01', '2024-01-31')